...
CREATE POLICY IF NOT EXISTS "Video assets are viewable by authenticated users"
...
CREATE POLICY IF NOT EXISTS "Subtitles are viewable by authenticated users"
ON public.subtitles
FOR SELECT
TO authenticated
USING (true);
...
CREATE POLICY IF NOT EXISTS "Video-category links are viewable by authenticated users"
